 ...
 *       &lt;sequence>
 *         &lt;element name="ValidValues" type="{http://www.w3.org/2001/XMLSchema}int" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends PrimitiveAttribute
{
    ...
    @XmlElement(name = "ValidValues", type = Integer.class)
    protected List<Integer> validValues;
